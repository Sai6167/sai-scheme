      ...
      <table className="styled-table">
        <thead>
          <tr>
            ...
            <th style={{ textAlign: "left" }}>Scheme Name</th>
            <th style={{ textAlign: "left" }}>Scheme Eligible</th>
            <th style={{ textAlign: "left" }}>Scheme Benefit</th>
            {/* <th style={{ textAlign: "left" }}>Scheme Details</th> */}
            <th style={{ textAlign: "left" }}>Scheme Documents</th>
            <th style={{ textAlign: "left" }}>State</th>
            <th style={{ textAlign: "left" }}>Status</th>
            <th style={{ textAlign: "left" }}>Action</th>
            {/*/{!sort && <th style={{ textAlign: "left" }}>Action</th> }*/}
          </tr>
        </thead>
        {!sort && (
          <tbody>
              ...
              return Object.keys(state).map((item) => {
                ...
                return (
                  <tr key={index}>
                    ...
                    <td className="state">{state[item].city}</td>
                    <td>{state[item].status}</td>
                    <td>
                      <Link to={`/update/${id}/${item}`}>
                        {/* /update/state/id */}
